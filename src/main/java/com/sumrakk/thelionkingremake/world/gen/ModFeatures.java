...
import com.sumrakk.thelionkingremake.world.gen.feature.BananaTreeFeature;
...
public class ModFeatures {
    ...
    public static final RegistryObject<Feature<BaseTreeFeatureConfig>> TWO_LAYER_RAINFOREST_TREE =
            FEATURES.register("two_layer_rainforest_tree", () -> new TwoLayerRainForestTreeFeature(BaseTreeFeatureConfig.CODEC));

    public static final RegistryObject<Feature<BaseTreeFeatureConfig>> GIANT_TWO_LAYER_RAINFOREST_TREE =
            FEATURES.register("giant_two_layer_rainforest_tree", () -> new TwoLayerRainForestTreeFeature(BaseTreeFeatureConfig.CODEC));

    // PassionTree фича
    public static final RegistryObject<Feature<BaseTreeFeatureConfig>> PASSION_TREE =
            FEATURES.register("passion_tree", () -> new PassionTreeFeature(BaseTreeFeatureConfig.CODEC));

    // MangoTree фича
    public static final RegistryObject<Feature<BaseTreeFeatureConfig>> MANGO_TREE =
            FEATURES.register("mango_tree", () -> new MangoTreeFeature(BaseTreeFeatureConfig.CODEC));

    // BananaTree фича с плодами
    public static final RegistryObject<Feature<BaseTreeFeatureConfig>> BANANA_TREE =
            FEATURES.register("banana_tree", () -> new BananaTreeFeature(BaseTreeFeatureConfig.CODEC));
}